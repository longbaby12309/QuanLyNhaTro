...
<head>
    ...
    <title>Quản Lý Nhà Trọ - ADMIN</title>
              ...
              <span class="app-brand-logo demo">
                <svg
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text menu-text fw-bold ms-2">Quản Lý Nhà Trọ</span>
                </a>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <h5 class="card-header">Danh sách Báo</h5>
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    $columnNames = ['STT', 'Mã Báo Cáo', 'Mã Nhà Trọ Báo Cáo', 'Số Lần Báo Cáo', 'Thời Gian Tạo'];
                                ...
                                <?php
                                include 'ketnoi.php';
                                $sql = "SELECT * FROM nha_tro_report";
                                ...
                                if ($result->num_rows > 0) {
                                    while($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>$stt</td>";
                                        echo "<td>{$row['nha_tro_report_id']}</td>";
                                        echo "<td>{$row['nha_tro_id']}</td>";
                                        echo "<td>{$row['number_report']}</td>";
